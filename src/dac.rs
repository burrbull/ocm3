...
impl Channel1 {
    ...
    pub fn set_trigger_source(&mut self, dac_trig_src: Trigger1Sel) {
        self.cr()
            .modify(|_, w| unsafe { w.tsel1().bits(dac_trig_src as u8) });
    }
}
...
impl Channel2 {
    ...
    pub fn set_trigger_source(&mut self, dac_trig_src: Trigger2Sel) {
        self.cr()
            .modify(|_, w| unsafe { w.tsel2().bits(dac_trig_src as u8) });
    }
}
...
impl ChannelDual {
    ...
    /// 12 bit.
    pub fn load_data_buffer(&self, dac_data1: u16, dac_data2: u16, dac_data_format: DataAlign) {
        let dac = unsafe { &*DAC::ptr() };
        match dac_data_format {
            DataAlign::Right8 => {
                dac.dhr8rd.write(|w| unsafe {
                    w.dacc1dhr()
                        .bits(dac_data1 as u8)
                        .dacc2dhr()
                        .bits(dac_data2 as u8)
                });
            }
            DataAlign::Right12 => {
                dac.dhr12rd
                    .write(|w| unsafe { w.dacc1dhr().bits(dac_data1).dacc2dhr().bits(dac_data2) });
            }
            DataAlign::Left12 => {
                dac.dhr12ld
                    .write(|w| unsafe { w.bits((dac_data1 as u32) | ((dac_data2 as u32) << 16)) });
            }
        }
    }
    ...
    pub fn set_trigger_source(&mut self, dac_trig_src1: Trigger1Sel, dac_trig_src2: Trigger2Sel) {
        self.cr().modify(|_, w| unsafe {
            w.tsel1()
                .bits(dac_trig_src1 as u8)
                .tsel2()
                .bits(dac_trig_src2 as u8)
        });
    }
    ...
    pub fn set_waveform_generation(&mut self, dac_wave_ens1: Wave, dac_wave_ens2: Wave) {
        self.cr().modify(|_, w| unsafe {
            w.wave1()
                .bits(dac_wave_ens1 as u8)
                .wave2()
                .bits(dac_wave_ens2 as u8)
        });
    }
    ...
    pub fn set_waveform_characteristics(&mut self, dac_mamp1: Mamp, dac_mamp2: Mamp) {
        self.cr().modify(|_, w| unsafe {
            w.mamp1()
                .bits(dac_mamp1 as u8)
                .mamp2()
                .bits(dac_mamp2 as u8)
        });
    }
}
...
impl DacChannelExt for Channel1 {
    fn enable(&mut self) {
        self.cr().modify(|_, w| w.en1().set_bit());
    }

    fn disable(&mut self) {
        self.cr().modify(|_, w| w.en1().clear_bit());
    }

    fn buffer_enable(&mut self) {
        self.cr().modify(|_, w| w.boff1().clear_bit());
    }

    fn buffer_disable(&mut self) {
        self.cr().modify(|_, w| w.boff1().set_bit());
    }

    fn dma_enable(&mut self) {
        self.cr().modify(|_, w| w.dmaen1().set_bit());
    }

    fn dma_disable(&mut self) {
        self.cr().modify(|_, w| w.dmaen1().clear_bit());
    }

    fn trigger_enable(&mut self) {
        self.cr().modify(|_, w| w.ten1().set_bit());
    }

    fn trigger_disable(&mut self) {
        self.cr().modify(|_, w| w.ten1().clear_bit());
    }

    fn disable_waveform_generation(&mut self) {
        self.cr().modify(|_, w| unsafe { w.wave1().bits(0b00) });
    }

    fn software_trigger(&self) {
        unsafe { &*DAC::ptr() }
            .swtrigr
            .write(|w| w.swtrig1().set_bit());
    }
}

impl DacChannelExt for Channel2 {
    fn enable(&mut self) {
        self.cr().modify(|_, w| w.en2().set_bit());
    }

    fn disable(&mut self) {
        self.cr().modify(|_, w| w.en2().clear_bit());
    }

    fn buffer_enable(&mut self) {
        self.cr().modify(|_, w| w.boff2().clear_bit());
    }

    fn buffer_disable(&mut self) {
        self.cr().modify(|_, w| w.boff2().set_bit());
    }

    fn dma_enable(&mut self) {
        self.cr().modify(|_, w| w.dmaen2().set_bit());
    }

    fn dma_disable(&mut self) {
        self.cr().modify(|_, w| w.dmaen2().clear_bit());
    }

    fn trigger_enable(&mut self) {
        self.cr().modify(|_, w| w.ten2().set_bit());
    }

    fn trigger_disable(&mut self) {
        self.cr().modify(|_, w| w.ten2().clear_bit());
    }

    fn disable_waveform_generation(&mut self) {
        self.cr().modify(|_, w| unsafe { w.wave2().bits(0b00) });
    }

    fn software_trigger(&self) {
        unsafe { &*DAC::ptr() }
            .swtrigr
            .write(|w| w.swtrig2().set_bit());
    }
}

impl DacChannelExt for ChannelDual {
    fn enable(&mut self) {
        self.cr().modify(|_, w| w.en1().set_bit().en2().set_bit());
    }
    ...
    fn buffer_enable(&mut self) {
        self.cr()
            .modify(|_, w| w.boff1().clear_bit().boff2().clear_bit());
    }

    fn buffer_disable(&mut self) {
        self.cr()
            .modify(|_, w| w.boff1().set_bit().boff2().set_bit());
    }

    fn dma_enable(&mut self) {
        self.cr()
            .modify(|_, w| w.dmaen1().set_bit().dmaen2().set_bit());
    }

    fn dma_disable(&mut self) {
        self.cr()
            .modify(|_, w| w.dmaen1().clear_bit().dmaen2().clear_bit());
    }

    fn trigger_enable(&mut self) {
        self.cr().modify(|_, w| w.ten1().set_bit().ten2().set_bit());
    }

    fn trigger_disable(&mut self) {
        self.cr()
            .modify(|_, w| w.ten1().clear_bit().ten2().clear_bit());
    }

    fn disable_waveform_generation(&mut self) {
        self.cr()
            .modify(|_, w| unsafe { w.wave1().bits(0b00).wave2().bits(0b00) });
    }
...
impl DacChannelSingleExt for Channel1 {
    fn load_data_buffer(&self, dac_data: u16, dac_data_format: DataAlign) {
        ...
        match dac_data_format {
            DataAlign::Right8 => {
                dac.dhr8r1.write(|w| unsafe { w.bits(dac_data as u32) });
            }
            DataAlign::Right12 => {
                dac.dhr12r1.write(|w| unsafe { w.bits(dac_data as u32) });
            }
            DataAlign::Left12 => {
                dac.dhr12l1.write(|w| unsafe { w.bits(dac_data as u32) });
            }
        }
    }
    ...
    fn set_waveform_generation(&mut self, dac_wave_ens: Wave) {
        self.cr()
            .modify(|_, w| unsafe { w.wave1().bits(dac_wave_ens as u8) });
    }

    fn set_waveform_characteristics(&mut self, dac_mamp: Mamp) {
        self.cr()
            .modify(|_, w| unsafe { w.mamp1().bits(dac_mamp as u8) });
    }
}
...
impl DacChannelSingleExt for Channel2 {
    fn load_data_buffer(&self, dac_data: u16, dac_data_format: DataAlign) {
        ...
        match dac_data_format {
            DataAlign::Right8 => {
                dac.dhr8r2.write(|w| unsafe { w.bits(dac_data as u32) });
            }
            DataAlign::Right12 => {
                dac.dhr12r2.write(|w| unsafe { w.bits(dac_data as u32) });
            }
            DataAlign::Left12 => {
                dac.dhr12l2.write(|w| unsafe { w.bits(dac_data as u32) });
            }
        }
    }
    ...
    fn set_waveform_generation(&mut self, dac_wave_ens: Wave) {
        self.cr()
            .modify(|_, w| unsafe { w.wave2().bits(dac_wave_ens as u8) });
    }

    fn set_waveform_characteristics(&mut self, dac_mamp: Mamp) {
        self.cr()
            .modify(|_, w| unsafe { w.mamp2().bits(dac_mamp as u8) });
    }
}
